...
Codex uses the plugin package under `plugins/ai-db-client`:

```text
plugins/ai-db-client/.codex-plugin/plugin.json
plugins/ai-db-client/.mcp.json
plugins/ai-db-client/skills/db-client/SKILL.md
```
...
Claude Code uses the repository root as the plugin source:
...
If you are not using plugin installation, add an MCP server entry that points to the built server:
...
cp plugins/ai-db-client/config/profiles.example.yaml ~/.config/ai-db-client/profiles.yaml
cp plugins/ai-db-client/config/projects.example.yaml ~/.config/ai-db-client/projects.yaml
```
...
skills/db-client/SKILL.md              Claude-facing agent workflow instructions
LICENSE                                Repository license
README.zh-CN.md                        Chinese documentation
plugins/ai-db-client/.codex-plugin/    Codex plugin manifest
plugins/ai-db-client/.mcp.json         MCP server entry
plugins/ai-db-client/skills/           Codex-facing agent workflow instructions
plugins/ai-db-client/src/              MCP server implementation
plugins/ai-db-client/dist/             Bundled MCP server used by installs
plugins/ai-db-client/config/           Public schemas and example config
```
